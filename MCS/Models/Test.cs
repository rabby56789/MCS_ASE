...
namespace MCS.Models
{
    ...
    /// </summary>
    public class Test : ISqlCreator
    {
        public string MasterTable { get { return "BASE_TEST"; } }
        public string HistoryTable { get { return "BASE_TEST_HISTORY"; } }
        ...
        public string Insert(string uuid)
        {
            ...
            sqlStr += string.Format(@"INSERT INTO {0}(GUID,TEST_GUID,ID,`NAME`,INSERT_USER,INSERT_TIME,UPDATE_USER,UPDATE_TIME,`ENABLE`,REMARK)", HistoryTable);
