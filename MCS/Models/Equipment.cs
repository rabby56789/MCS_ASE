...
namespace MCS.Models
{
    ...
    /// </summary>
    public class Equipment : ISqlCreator
    {
        public string MasterTable { get { return "BASE_EQUIPMENT"; } }
        public string HistoryTable { get { return "BASE_EQUIPMENT_HISTORY"; } }
        ...
        public string Search(JObject parm, bool getCount)
        {
            ...
            {
                sqlStr = string.Format(@"SELECT D.GUID,D.ID,D.NAME,D.REMARK,D.INSERT_TIME FROM {0} D ", MasterTable);
            }
        ...
        public string Insert(string uuid)
        {
            ...
            sqlStr += string.Format(@"INSERT INTO {0}(GUID,EQUIPMENT_GUID,ID,`NAME`,INSERT_USER,INSERT_TIME,UPDATE_USER,UPDATE_TIME,`ENABLE`,REMARK)", HistoryTable);
