...
namespace MCS.Models
{
    ...
    /// </summary>
    public class Trolley : ISqlCreator
    {
        public string MasterTable { get { return "BASE_TROLLEY"; } }
        public string HistoryTable { get { return "BASE_TROLLEY_HISTORY"; } }
        ...
        public string Search(JObject parm, bool getCount)
        {
            ...
            {
                sqlStr = string.Format(@"SELECT D.GUID,D.ID,D.NAME,D.TYPE,D.REMARK,D.INSERT_TIME FROM {0} D ", MasterTable);
            }
        ...
        {
            string sqlStr = string.Format(@"SELECT D.GUID,D.ID,D.NAME,D.TYPE,D.REMARK FROM {0} D ", MasterTable);
        ...
        {
            string sqlStr = string.Format(@"INSERT INTO {0} (GUID,ID,NAME,TYPE,REMARK,INSERT_USER,INSERT_TIME) ", MasterTable);
            sqlStr += $@"VALUES ('{uuid}',@ID,@NAME,@TYPE,@REMARK,@INSERT_USER,now());";
            sqlStr += string.Format(@"INSERT INTO {0}(GUID,TROLLEY_GUID,ID,`NAME`,TYPE,INSERT_USER,INSERT_TIME,UPDATE_USER,UPDATE_TIME,`ENABLE`,REMARK) ", HistoryTable);
            sqlStr += string.Format(@"SELECT UUID(), GUID,ID,`NAME`,TYPE,INSERT_USER,INSERT_TIME,UPDATE_USER,UPDATE_TIME,`ENABLE`,REMARK FROM {0} ", MasterTable);
