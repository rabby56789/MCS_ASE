...
namespace MCS.Models
{
    ...
    /// </summary>
    public class Factory : ISqlCreator
    {
        public string MasterTable { get { return "BASE_FACTORY"; } }
        public string HistoryTable { get { return "BASE_FACTORY_HISTORY"; } }
        ...
        public string Insert(string uuid)
        {
            ...
            sqlStr += string.Format(@"INSERT INTO {0}(GUID,FACTORY_GUID,ID,`NAME`,INSERT_USER,INSERT_TIME,UPDATE_USER,UPDATE_TIME,`ENABLE`,REMARK)", HistoryTable);
