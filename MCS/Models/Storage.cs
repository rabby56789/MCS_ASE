...
namespace MCS.Models
{
    ...
    /// </summary>
    public class Storage : ISqlCreator
    {
        public string MasterTable { get { return "BASE_STORAGE"; } }
        public string HistoryTable { get { return "BASE_STORAGE_HISTORY"; } }
        public string SubTableStorage { get { return "BASE_AGVSTORAGE"; } }
        ...
        public string Search(JObject parm, bool getCount)
        {
            ...
            {
                sqlStr = string.Format(@"SELECT D.GUID,D.ID,D.NAME,D.QRCODE,D.REMARK,D.INSERT_TIME FROM {0} D ", MasterTable);
            }
            ...
            {
                sqlStr += "AND D.QRCODE LIKE CONCAT(@QRCODE , '%') ";
            }
            //建立時間-起
        ...
        {
            string sqlStr = string.Format(@"SELECT D.GUID,D.ID,D.NAME,D.QRCODE,D.REMARK FROM {0} D ", MasterTable);
