...
namespace MCS.Models
{
    ...
    /// </summary>
    public class Weighting : ISqlCreator
    {
        public string MasterTable { get { return "BASE_WEIGHTING"; } }
        public string HistoryTable { get { return "BASE_WEIGHTING_HISTORY"; } }
        ...
        {
            string sqlStr = string.Format(@"INSERT INTO {0} (GUID,ID,NAME,PRIORITY,REMARK,INSERT_USER,INSERT_TIME) ", MasterTable);
            sqlStr += $@"VALUES ('{uuid}',@ID,@NAME,@PRIORITY,@REMARK,@INSERT_USER,now());";
            sqlStr += string.Format(@"INSERT INTO {0}(GUID,WEIGHTING_GUID,ID,NAME,PRIORITY,INSERT_USER,INSERT_TIME,UPDATE_USER,UPDATE_TIME,`ENABLE`,REMARK)", HistoryTable);
            sqlStr += string.Format(@"SELECT UUID(), GUID,ID,NAME,PRIORITY,INSERT_USER,INSERT_TIME,UPDATE_USER,UPDATE_TIME,`ENABLE`,REMARK FROM {0} ", MasterTable);
