...
namespace MCS.Controllers
{
    ...
    /// 
    /// </summary>
    public class LogUpperYageoController : Controller
    {
        public ActionResult Index()
        {
            return View("~/Views/Log/LogApiYageo.cshtml");
        }
    }

    public class ApiLogYageoController : ApiController
    {
        ...
        public JObject Query(JObject obj)
        {
            ...
            LogYageo sqlCreator = new LogYageo();
            DAO dao = new DAO();
