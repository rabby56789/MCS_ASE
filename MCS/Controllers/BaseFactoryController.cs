...
{
    public class BaseFactoryController : Controller 
    {
        
        // GET: Factory
        public ActionResult Index()
        {
            return View("~/Views/Base/Factory.cshtml");
        }
                
    }
    public class ApiFactoryController : ApiController, IJqOneTable
    {
        [System.Web.Http.HttpPost]
        public JObject Count(JObject obj)
        {
            Factory sqlCreator = new Factory();
            DAO dao = new DAO();
