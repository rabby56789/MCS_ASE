...
{
    public class BaseAirshowerController : Controller 
    {
        
        // GET: Factory
        public ActionResult Index()
        {
            return View("~/Views/Base/Airshower.cshtml");
        }
                
    }

    public class ApiAirshowerController : ApiController, IJqOneTable
    {
        [System.Web.Http.HttpPost]
        public JObject Query(JObject obj)
        {
            Airshower sqlCreator = new Airshower();
            DAO dao = new DAO();
