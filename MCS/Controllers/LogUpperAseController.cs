...
namespace MCS.Controllers
{
    ...
    /// 
    /// </summary>
    public class LogUpperAseController : Controller
    {
        public ActionResult Index()
        {
            return View("~/Views/Log/LogUpperAse.cshtml");
        }
    }

    public class ApiLogUpperAseController : ApiController
    {
