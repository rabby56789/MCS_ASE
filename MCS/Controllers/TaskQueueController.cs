...
namespace MCS.Controllers
{
    public class TaskQueueController : Controller
    {
        ...
        {
            return View("~/Views/Task/TaskQueue.cshtml");
        }
        #region XML上傳
...
#endregion
public class apiTaskQueueController : ApiController, IJqOneTable
{
    [System.Web.Http.HttpPost]
    public JObject Count(JObject obj)
    {
        TaskQueue sqlCreator = new TaskQueue();
        DAO dao = new DAO();
    ...
    public JObject Delete(JObject obj)
    {
        ...
        //
        //增加ELVT_INFO資料清定
        //var sqlCancelElvt_INFO = sqlCreator.CancelElvt_INFO();
        //dao.AddExecuteItem(sqlCancelElvt_INFO,sqlParms);
