...
{
    public class BaseStatusController : Controller
    {

        // GET: Status
        public ActionResult Index()
        {
            return View("~/Views/Base/Status.cshtml");
        }
    }

    public class apiStatusController : ApiController, IJqOneTable
    {
        [System.Web.Http.HttpPost]
        public JObject Count(JObject obj)
        {
            Status sqlCreator = new Status();
            DAO dao = new DAO();
