...
{
    public class SysParamaterController : Controller
    {

        // GET: Paramater
        public ActionResult Index()
        {
            return View("~/Views/SYS/Paramater.cshtml");
        }

    }
    public class ApiSysParamaterController : ApiController, IJqOneTable
    {
        [System.Web.Http.HttpPost]
        public JObject Count(JObject obj)
        {
            Paramater sqlCreator = new Paramater();
            DAO dao = new DAO();
        ...
        public JObject Query(JObject obj)
        {
            ...
            returnVal.Add("showType", parm.showType);
        ...
        public JObject SearchFunctionID(JObject obj)
        {
            Paramater sqlCreator = new Paramater();
            DAO dao = new DAO();
            DataTableExtensions extensions = new DataTableExtensions();
            ...
            var sqlStr = sqlCreator.GetSqlStr("SearchFunctionID", obj);
            var sqlParms = sqlCreator.CreateParameterAry(obj);
