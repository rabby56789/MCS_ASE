...
{
    public class BaseTrolleyController : Controller
    {

        // GET: Storage
        public ActionResult Index()
        {
            return View("~/Views/Base/Trolley.cshtml");
        }

    }
    public class ApiTrolleyController : ApiController, IJqOneTable
    {
        [System.Web.Http.HttpPost]
        public JObject Count(JObject obj)
        {
            Trolley sqlCreator = new Trolley();
            DAO dao = new DAO();
