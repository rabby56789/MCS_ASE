...
{
    public class BaseAgvGroupController : Controller 
    {
        
        // GET: Factory
        public ActionResult Index()
        {
            return View("~/Views/Base/AgvGroup.cshtml");
        }
                
    }
    public class ApiAgvGroupController : ApiController, IJqOneTable
    {
        [System.Web.Http.HttpPost]
        public JObject Query(JObject obj)
        {
            AgvGroup sqlCreator = new AgvGroup();
            DAO dao = new DAO();
