...
{
    public class BaseFloorController : Controller 
    {
        
        // GET: Factory
        public ActionResult Index()
        {
            return View("~/Views/Base/Floor.cshtml");
        }
                
    }
    public class ApiFloorController : ApiController, IJqOneTable
    {
        [System.Web.Http.HttpPost]
        public JObject Count(JObject obj)
        {
            Floor sqlCreator = new Floor();
            DAO dao = new DAO();
