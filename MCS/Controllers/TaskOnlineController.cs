...
{
    public class TaskOnlineController : Controller
    {

        // GET: Factory
        public ActionResult Index()
        {
            return View("~/Views/Task/TaskOnline.cshtml");
        }
        #region XML上傳
...
#endregion
public class apiTaskOnlineController : ApiController, IJqOneTable
{
    [System.Web.Http.HttpPost]
    public JObject Count(JObject obj)
    {
        TaskOnline sqlCreator = new TaskOnline();
        DAO dao = new DAO();
    ...
    public JObject Delete(JObject obj)
    {
        ...
        var sqlParms = sqlCreator.CreateParameterAry(obj);//參數
        ...
        //增加同步取消梯控任務
        var sqlCancelElvt= sqlCreator.CancelElvtTask();
        dao.AddExecuteItem(sqlCancelElvt, sqlParms);

        //增加同步取消booking
        var sqlUnbooking = sqlCreator.ToUnbooking();
        dao.AddExecuteItem(sqlUnbooking, sqlParms);
    ...
    public JObject Export(JObject obj)
    {
        ...
        string controllerName = "TaskHistory";
