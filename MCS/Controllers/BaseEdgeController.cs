...
{
    public class BaseEdgeController : Controller 
    {
        
        // GET: Factory
        public ActionResult Index()
        {
            return View("~/Views/Base/Edge.cshtml");
        }
                
    }
    public class ApiEdgeController : ApiController, IJqOneTable
    {
        [System.Web.Http.HttpPost]
        public JObject Count(JObject obj)
        {
            Edge sqlCreator = new Edge();
            DAO dao = new DAO();
