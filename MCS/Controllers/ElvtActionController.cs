...
{
    public class ElvtActionController : Controller 
    {
        
        // GET: Factory
        public ActionResult Index()
        {
            return View("~/Views/Cmd/ElvtAction.cshtml");
        }
                
    }
    public class ApiElvtActionController : ApiController, IJqOneTable
    {
        [System.Web.Http.HttpPost]
        public JObject Query(JObject obj)
        {
            ElvtAction sqlCreator = new ElvtAction();
            DAO dao = new DAO();
        ...
        //取電梯資料
        [System.Web.Http.HttpPost]
        public JObject GetDataListElvt(JObject obj)
        {
            ElvtAction sqlCreator = new ElvtAction();
            DAO dao = new DAO();
            DataTableExtensions extensions = new DataTableExtensions();
            ...
            var sqlStr = sqlCreator.GetDataListElvt(obj);
            var sqlParms = sqlCreator.CreateParameterAry(obj);
        ...
        //取得電梯總數量
        [System.Web.Http.HttpPost]
        public JObject GetElvtCount(JObject obj)
        {
            ElvtAction sqlCreator = new ElvtAction();
            DAO dao = new DAO();
            DataTableExtensions extensions = new DataTableExtensions();

            var sqlStr = sqlCreator.GetElvtCount(obj);
            var sqlParms = sqlCreator.CreateParameterAry(obj);
        ...
        //取電梯資料
        [System.Web.Http.HttpPost]
        public JObject GetDataListCmd(JObject obj)
        {
            ElvtAction sqlCreator = new ElvtAction();
            DAO dao = new DAO();
            DataTableExtensions extensions = new DataTableExtensions();
            ...
            //計算Count
            //先抓count 頭
            var sqlStr = sqlCreator.GetCmdCount(obj);
            ...
            sqlStr = sqlCreator.GetDataListCmd(obj);
